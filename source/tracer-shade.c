...
/*
	...
	Calculates color at the point of intersection

	Given the intersection point shade() calculates the
	actual color at that point.  
	
	This may involve extra calls to trace for reflection
	and refraction.
