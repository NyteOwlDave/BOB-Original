/*
	...
	Generate bounding slabs and create composite objects
*/
...
void BuildBoundingSlabs(void) {
	...
	if (tickflag) {
		printf("\n\tAfter adding bounding volumes, %d prims.\n", nPrims);
		if (Root) {
...
//
// Updates the Median and Axis variables
//
...
//
// Sorts primitive objects into composite bunches
// and adjusts the bounding slabs for the top-level
// primitive in each composite.
//
