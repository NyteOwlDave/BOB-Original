 ...
 *              Targa file (type 2) and will be displayed.
 *
 *              If the "/I" switch is used then information
 *              about the file will be displayed.
 *
 *
 * NOTE:	I've deleted the assembler code for setting VGA video
 *			modes and writing VGA scanlines. This needs to be
 *			redesigned to view in an X-Window bitmap.
 *
 ************************************************************************/
